...
button.on("click", function() {
    ...
    var durationInputElement = d3.select("#durationMinutes");
    var durationInputValue = durationInputElement.property("value");
    console.log(durationInputValue);
    ...
    if (durationInputValue !== "") {
        filteredData = filteredData.filter(sighting => sighting.durationMinutes === durationInputValue);
    }
